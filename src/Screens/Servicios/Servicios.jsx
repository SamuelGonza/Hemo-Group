        ...
        <div className="tarjetas-servicios-container">
          <div className="servicio-tarjeta">
            ...
            <div className="servicio-info">
              <Typography variant="h6">Consulta Externa</Typography>
              <Typography variant="body2">
                La IPS Hemo group cuenta con una atención ambulatoria para
                consulta médica especializada con 5 consultorios
              </Typography>
              <Typography variant="body2">
                Se cuenta con un grupo de especialistas cualificado, con el
                objetivo de acompañar y guiar el diagnóstico oportuno e integral
                de los pacientes
              </Typography>
            </div>
          </div>
          ...
          <div className="servicio-tarjeta">
            ...
            <div className="servicio-info">
              ...
              <Typography variant="body2">
                ...
                1 camilla para administración de terapia prolongada <br />1 sala
                de procedimientos.
              </Typography>
            </div>
          </div>
